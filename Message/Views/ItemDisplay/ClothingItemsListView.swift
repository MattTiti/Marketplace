...
struct ClothingItemListView: View {
    ...
    var body: some View {
        NavigationView {
            ScrollView{
                VStack {
                    ForEach(viewModel.clothing.chunked(into: 3), id: \.self) { items in
                        HStack {
            ...
            .navigationTitle("Clothing").navigationBarTitleDisplayMode(.inline)
            .toolbar {
