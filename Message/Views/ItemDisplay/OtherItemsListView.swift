        ...
        NavigationView {
            ScrollView{
                VStack {
                    ...
                    ForEach(viewModel.other.chunked(into: 3), id: \.self) { items in
                        HStack {
            ...
            .navigationTitle("Others").navigationBarTitleDisplayMode(.inline)
            .toolbar {
