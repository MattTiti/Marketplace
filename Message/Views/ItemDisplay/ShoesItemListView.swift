        ...
        NavigationView {
            ScrollView{
                VStack {
                    ...
                    ForEach(viewModel.shoes.chunked(into: 3), id: \.self) { items in
                        HStack {
            ...
            .navigationTitle("Shoes").navigationBarTitleDisplayMode(.inline)
            .toolbar {
