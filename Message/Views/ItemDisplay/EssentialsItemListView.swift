...
struct EssentialsItemListView: View {
        ...
        NavigationView {
            ScrollView{
                VStack {
                    ...
                    ForEach(viewModel.essentials.chunked(into: 3), id: \.self) { items in
                        HStack {
            ...
            .navigationTitle("Essentials").navigationBarTitleDisplayMode(.inline)
            .toolbar {
